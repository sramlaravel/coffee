@php
    $Description_for_buyer = getContent('Description_for_buyers.content', true);
    $Description_for_buyers = getContent('Description_for_buyers.element', false, 4, true);
@endphp
...
<section class="topgrade__area topgrade__area--2 grey-bg pt-115 pb-115 position-relative">
    ...
    <span class="shape shape__2 position-absolute"><img src="assets/images/shape/top-grade-shape-2-2.png" alt=""></span>
       ...
       <div class="best-coffe__area position-relative">
        <div class="best-coffe__bg">
            <img src="{{getImage('assets/images/frontend/Description_for_buyers/'.$Description_for_buyer->data_values->image1,'300x400') }}" alt="">
        </div>
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-xl-8 pl-35">
                    <div class="best-coffe__wrapper">
                        <div class="section-heading section-heading__black">
                            <h2 class="title mb-25">{{__($Description_for_buyer->data_values->heading)}}</h2>
                            <p   class="col-xl-12"  style="text-align: center; color: #0a0e26;" >
                                {{__($Description_for_buyer->data_values->sub_heading)}}
                            </p>
                        </div>
                    </div>
                </div>
