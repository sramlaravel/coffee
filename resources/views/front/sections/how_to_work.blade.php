@php 
    ...
    $howToWorks = getContent('how_to_work.element', false, 4, true);
@endphp
...
<div class="container">
    <div class="section-heading section-heading__black mb-40">
        <h3 class="title"  style="text-align: center;"  >{{__($howToWork->data_values->heading)}}</h3>
            ...
            <div class="col-xl-12">
                <div class="feature__wrapper">
                    ...
                    <div class="row mt-none-50">
                        @foreach($howToWorks as $key=>  $value)
