@php
    $Why_producer = getContent('Why_producers.content', true);
    $Why_producers = getContent('Why_producers.element', false, 4, true);
@endphp
        ...
        <div class="row">
            ...
            <div class="col-xl-6 offset-xl-1">
                <div class="about__right about__right--2 pl-45 pt-45">
                    <div class="section-heading section-heading__black">
                        ...
                        <h2 class="title mb-25">{{__($Why_producer->data_values->heading)}}
                             </h2>
                        <p>{{__($Why_producer->data_values->sub_heading)}}</p>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-7">
                <div class="about__left about__right--1 position-relative">
                    <img class="big" src="{{getImage('assets/images/frontend/Why_producers/'.$Why_producer->data_values->image2,'100x150') }}" alt="img">
