    ...
    <div class="container">
                ...
                <div class="footer-wrapper">
                    {{--@foreach($categories as $category)--}}
                        <div class="footer__widget">
                            <h6 class="title"><a href="" class="text--base"></a></h6>
                            <ul>
                                {{--@foreach($category->subCategory as $subCategory)--}}
                                    <li>
                                        <a href=""></a>
                                    </li>
                                {{--{{__($subCategory->name)}} {{route('subcategory.product', $subCategory->id)}}--}}
                                {{--{{__($category->name)}}--}}
                                {{--{{route('category.product', $category->id)}}--}}
                                {{--@endforeach--}}
                            </ul>
                        </div>
                    {{--@endforeach--}}
        ...
        <div class="footer-bottom">
            <div class="footer-bottom-wrapper">
                <div class="copyright">
                    &copy; {{Carbon\Carbon::now()->format('Y')}} @lang('All Right Reserved by') <a href="{{route('home')}}" class="text--base"> </a>
                </div>
