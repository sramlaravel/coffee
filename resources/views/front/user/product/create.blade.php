	                        ...
	                        <form action="{{route('user.product.store')}}"  method="post" enctype="multipart/form-data">
		                        ...
		                        <div class="row">
		                            <div class="col-md-12 mb-20">
		                                ...
		                                <select class="form-control form--control-2 bg--body select2-auto-tokenize" name="keywords[]" multiple="multiple" type="text" name="keyword"   required="">
											<option value="">@lang('Enter Key words')</option>
										</select>
		                            </div>
		                        </div>
